            ...
            try {
                ...
                if (/^~/.test(line)) {
                    ...
                    if (sectionName == parameterTitle || (lasVersion == 2 && sectionName == curveTitle)) {
                        ...
                        if (wellInfo.datasets[wellInfo.name + logDataIndex]) return;
                        isFirstCurve = true;
                        let dataset = {
                        ...
                        wellInfo.datasets[wellInfo.name + logDataIndex] = dataset;
                        ...
                        if (wellInfo.datasets[datasetName]) return;
                        let dataset = {
                            name: datasetName,
                            curves: [],
                            top: 0,
                        ...
                        wellInfo.datasets[datasetName] = dataset;
                    ...
                    if (sectionName == asciiTitle || new RegExp(dataTitle).test(sectionName)) {
                        ...
                        wellInfo.datasets[currentDatasetName].curves.forEach(curve => {
                    ...
                    if (/VERSION/.test(sectionName) || sectionName == "V") {
                        ...
                        if (sectionName == parameterTitle) {
                            if (mnem == 'SET') wellInfo.datasets[wellInfo.name + logDataIndex].name = data;
                            wellInfo.datasets[wellInfo.name + logDataIndex].params.push({
                                mnem: mnem,
                                value: data,
                                description: description,
                                unit: paramUnit
                            ...
                            wellInfo.datasets[sectionName.replace('_' + parameterTitle, '')].params.push({
                                mnem: mnem,
                                value: data,
                                description: description
                            })
                        ...
                        if (isFirstCurve) {
                            ...
                            wellInfo.datasets[currentDatasetName].unit = unit;
                            return;
                        }
                        ...
                        let suffix = 1;
                        while (true) {
                            let rename = wellInfo.datasets[currentDatasetName].curves.every(curve => {
                        ...
                        wellInfo.datasets[currentDatasetName].curves.push(curve);
